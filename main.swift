...
//단위에따라 값 변환하는 함수들
func cmTom(cm: Double) -> Double { return cm / m_cm_num }
func mTocm(m: Double) -> Double { return m * m_cm_num }
func cmToinch(cm: Double) -> Double { return cm * inch_cm_num }
func inchTocm(inch: Double) -> Double { return inch / inch_cm_num }
func mToinch(m: Double) -> Double { return m * (inch_cm_num / m_cm_num) }
func inchTom(inch: Double) -> Double { return inch / (inch_cm_num / m_cm_num) }
func yardTocm(yard: Double) -> Double { return yard * yard_cm_num }
func cmToyard(cm: Double) -> Double { return cm / yard_cm_num }
func yardTom(yard: Double) -> Double { return yard * (yard_cm_num / m_cm_num) }
func mToyard(m: Double) -> Double { return m / (yard_cm_num / m_cm_num) }
